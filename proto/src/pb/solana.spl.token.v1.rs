...
pub struct Transfer {
    ...
    pub authority: ::prost::alloc::vec::Vec<::prost::alloc::vec::Vec<u8>>,
    #[prost(uint64, tag="13")]
    pub amount: u64,
    /// uint8
...
impl Instructions {
    ...
    pub fn as_str_name(&self) -> &'static str {
        match self {
            ...
            Instructions::InitializeMint2 => "INSTRUCTIONS_INITIALIZE_MINT2",
        }
    }
    ...
    pub fn from_str_name(value: &str) -> ::core::option::Option<Self> {
        match value {
            ...
            "INSTRUCTIONS_INITIALIZE_MINT2" => Some(Self::InitializeMint2),
            _ => None,
        }
    }
}
