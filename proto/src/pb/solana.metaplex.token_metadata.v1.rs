...
pub struct Instruction {
    ...
    #[prost(bool, tag="3")]
    pub is_root: bool,
    #[prost(oneof = "instruction::Instruction", tags = "8, 9, 10, 11, 12")]
...
pub mod instruction {
    ...
    pub enum Instruction {
        #[prost(message, tag = "8")]
        CreateMetadataAccountV1(super::CreateMetadataAccountV1),
        #[prost(message, tag = "9")]
        CreateMetadataAccountV2(super::CreateMetadataAccountV2),
        #[prost(message, tag = "10")]
        CreateMetadataAccountV3(super::CreateMetadataAccountV3),
        #[prost(message, tag = "11")]
        UpdateMetadataAccountV1(super::UpdateMetadataAccountV1),
...
#[allow(clippy::derive_partial_eq_without_eq)]
#[derive(Clone, PartialEq, ::prost::Message)]
pub struct CreateMetadataAccountV1 {
    #[prost(bytes="vec", tag="1")]
    pub metadata: ::prost::alloc::vec::Vec<u8>,
    #[prost(bytes="vec", tag="2")]
    pub mint: ::prost::alloc::vec::Vec<u8>,
...
#[allow(clippy::derive_partial_eq_without_eq)]
#[derive(Clone, PartialEq, ::prost::Message)]
pub struct UpdateMetadataAccountV1 {
    #[prost(bytes="vec", tag="1")]
    pub metadata: ::prost::alloc::vec::Vec<u8>,
    #[prost(bytes="vec", tag="2")]
    pub update_authority: ::prost::alloc::vec::Vec<u8>,
