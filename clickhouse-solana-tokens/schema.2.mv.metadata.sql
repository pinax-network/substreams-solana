...
/* MINT AUTHORITY */
CREATE TABLE IF NOT EXISTS metadata_mint_authority_state AS TEMPLATE_METADATA;
ALTER TABLE metadata_mint_authority_state
...
/* UPDATE AUTHORITY */
CREATE TABLE IF NOT EXISTS metadata_update_authority_state AS TEMPLATE_METADATA;
ALTER TABLE metadata_update_authority_state
