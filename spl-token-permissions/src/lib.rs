            ...
            match TokenInstruction::unpack(&instruction.data()) {
                ...
                Ok(token_instruction) => match token_instruction {
                    ...
                    TokenInstruction::FreezeAccount {} => {
                        ...
                        base.instruction = Some(pb::instruction::Instruction::FreezeAccount(pb::FreezeAccount {
                            // authority
                            authority,
                            multisig_authority,
                            account,
                    ...
                    TokenInstruction::ThawAccount {} => {
                        ...
                        base.instruction = Some(pb::instruction::Instruction::ThawAccount(pb::ThawAccount {
                            authority,
                            multisig_authority,
                            account,
                            mint,
