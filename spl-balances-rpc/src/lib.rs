...
use proto::pb::solana::spl::balances::v1::{BalanceByAccount, Events};

#[substreams::handlers::map]
fn map_events(params: String, spl_transfers: SPLTransfers) -> Result<Events, substreams::errors::Error> {
